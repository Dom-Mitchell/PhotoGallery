...
import jPhotos from '../jason_photos.json'
          ...
          <div className="info-card">
            <div className="card-info">
              <div className="card-content">
                <h2>
                  <Link to={`/${Object.keys(jPhotos)[0]}`}>
                    {jPhotos.pandas.title}
                  </Link>
                </h2>

                <p>{jPhotos.pandas.description}</p>
              </div>
            </div>
            <div className="card-picture">
              <figure className="image">
                <img className="main-img" src={jPhotos.pandas.photos[0].imageURL} />
              </figure>
            </div>
          </div>
        </div>
        ...
        <div className="pane">
          <div className="info-card">
            <div className="card-info">
              <div className="card-content">
                <h2>
                  <Link to={`/${Object.keys(jPhotos)[1]}`}>
                    {jPhotos.miniatures.title}
                  </Link>
                </h2>

                <p>{jPhotos.miniatures.description}</p>
              </div>
            </div>
            <div className="card-picture">
              <figure className="image">
                <img className="main-img" src={jPhotos.miniatures.photos[0].imageURL} />
              </figure>
            </div>
          </div>
        </div>
        ...
        {/* <div className="pane">
          <div className="info-card">
            <div className="card-info">
              <div className="card-content">
                <h2>
                  <Link to="/miniatures">{jPhotos.miniatures.title}</Link>
                </h2>
                <p>{jPhotos.miniatures.description}</p>
                <img
                  src={jPhotos.miniatures.photos[0].imageURL}
                  width="600px"
                />
              </div>
            </div>
