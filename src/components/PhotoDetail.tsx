...
import photos from '../jason_photos.json'
...
export function PhotoDetail() {
  ...
  return (
	...
	c0,15.555,12.655,28.21,28.21,28.21s28.21-12.655,28.21-28.21C284.21,168.752,271.555,156.097,256,156.097z"
      ...
      <h3>{photos[params.things].photos[Number(params.photoIndex)].title}</h3>
      <figure className="image">
        <img
          className="big-img"
          src={photos[params.things].photos[Number(params.photoIndex)].imageURL}
        />
      </figure>
      <p className="source-text">
        <a
          href={
            photos[params.things].photos[Number(params.photoIndex)].sourceURL
          }
        >
          Soure
        </a>
