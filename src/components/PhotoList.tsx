...
export function PhotoList() {
  ...
  return (
	...
	c0,15.555,12.655,28.21,28.21,28.21s28.21-12.655,28.21-28.21C284.21,168.752,271.555,156.097,256,156.097z"
      ...
      <h3>{photos[params.things].title}</h3>
      <h4>{photos[params.things].description}</h4>

      <div className="panes panes-multiline">
        {photos[params.things].photos.map((photo, index) => {
          return (
            <>
              <div className="pane panes-one-third">
